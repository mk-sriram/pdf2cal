...
const HomeSection = () => {
  return (
    <section className="flex flex-col items-center justify-start h-[11rem] md:h-[15rem]  text-center px-4 md:px-0 pt-[50px] mb-[40px]">
      <div className="max-w-3xl">
        <div className="flex flex-col items-center mb-4 space-y-[1px] md:space-y-[15px]">
          <div className="text-4xl md:text-7xl font-bold custom-gradient h-[50px] md:h-[80px] ">
            <Typewriter
              options={{
